...
const covidTest = [
  ...
  },
  {
    ...
    bgColor: "#fdedbe",
    testPara:
      "The COVID Home Care Complete package offers 41 tests (Includes D-Dimer, IL-6, HbA1c, Serum electrolytes, etc., in addition to  and more) that give important clues about the various health parameters.",
    testDetail: [
      {
        text: "Have been diagnosed with COVID-19 and need to understand how COVID-19 has impacted your health",
      },
