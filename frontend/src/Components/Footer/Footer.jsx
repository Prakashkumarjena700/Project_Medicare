    ...
    <Box>
      ...
      >
        ...
        >
          ...
          >
            <Stack align={"center"}>
              <ListHeader fontSize="16px">Known Us</ListHeader>
              {known.map((el) => (
                <Link
                  key={uuidv4()}
                  lineHeight="1.81"
            ...
            <Stack align={"center"}>
              <ListHeader fontSize="16px">Our Policies</ListHeader>
              {policy.map((el) => (
                <Link
                  key={uuidv4()}
                  lineHeight="1.81"
            ...
            <Stack align={"center"}>
              <ListHeader fontSize="16px">Our Services</ListHeader>
              {services.map((el) => (
                <Link
                  key={uuidv4()}
                  lineHeight="1.81"
            ...
            <Stack align={"center"}>
              <ListHeader fontSize="16px">Connect</ListHeader>
              <Link href={"#"} lineHeight="1.81" fontSize="14px" color="#666">
                Social Links
              </Link>
             ...
             <Button backgroundColor="#FF6F61" color="#FFFFFF">Sign Up</Button>
            </Stack>
            ...
            <Stack align={"center"}>
              ...
              >
                <Image src="https://www.pngmart.com/files/10/Get-It-On-Google-Play-PNG-Pic.png" width="144px" />
              </Box>
              <Box
                key={uuidv4()}
                as="a"
              ...
              >
              <Image src="https://www.freepnglogos.com/uploads/app-store-logo-png/download-on-the-app-store-logo-png-23.png" width="240px" />
              </Box>  
            </Stack>
          </SimpleGrid>
        </Container>
            ...
            {Data.map((el) => (
              <Box className={style.footerStamp} key={uuidv4()}>
                ...
                <Box>
                  ...
                  <Text lineHeight="1.81" fontSize="12px" color="#767676">
                    {el.desc}
                  </Text>
                </Box>
              </Box>
        ...
        >
          <AccordionItem>
            <h2>
              <AccordionButton>
                <Box flex="1" textAlign="left" fontWeight="bold" fontSize="14px">
            ...
            <AccordionPanel pb={4}>
              <Text as="h6" fontWeight="bold" textAlign="left" fontSize="16px">
